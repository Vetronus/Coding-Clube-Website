            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="#">
                    ...
                    <div class="flex flex-row">
                        ...
                        <button type="button" @click.prevent="createEvent" class=" mx-1 w-full text-white bg-indigo-500 hover:bg-indigo-600 active:bg-indigo-400 focus:outline-none font-medium rounded text-sm px-5 py-2.5 text-center">Create</button>
                    </div>
                </form>
            </div>
        </div>
